...
const projects = () => {
    ...
    const aicheContext = 'I am Submiting all the tasks here with proof and source code. Here I have solved all the problems given by them.'
